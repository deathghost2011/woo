...
public class ZizhucanFragment extends Fragment {
	public static ZizhucanFragment springHotFragment;
	private View rootView;

	/*
	 * 执行顺序先后 onAttach onCreate :保存恢复数据 onCreateView onActivityCreated 具体操作
	 */
	public static ZizhucanFragment getInstance(Bundle args) {
		springHotFragment = new ZizhucanFragment();
		if (args != null) {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		rootView = inflater.inflate(R.layout.fragment_restaurant_zizhucan, null);
