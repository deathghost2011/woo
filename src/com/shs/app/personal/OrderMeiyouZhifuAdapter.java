...
public class OrderMeiyouZhifuAdapter extends BaseAdapter {
	...
	public OrderMeiyouZhifuAdapter(Context mContext) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(mContext).inflate(
					R.layout.order_meiyou_zhifu_item, null);
			...
			viewHolder.zhifu = (TextView) convertView
					.findViewById(R.id.zhifu_order);
	...
	private void initListener(final ViewHolder viewHolder,final int postion) {
		...
		viewHolder.zhifu.setOnClickListener(new OnClickListener() {

				@Override
				public void onClick(View v) {
					 PublicClass.setPATH(Manager.dingdanzhifu);
					 String dingdanid=viewHolder.id_order.getText().toString();
				 	 PublicClass.setOrder_no(dingdanid);
					 setorderstate("该订单支付");
					 Intent intent = new
	...
	private class ViewHolder {
		TextView delete, detail, zhifu,id_order,hotel_name,in_date,out_date,money,pay_money,youhuimony;
	}
