...
public class QuantianFragment extends Fragment {
	public static QuantianFragment springHotFragment;
	private View rootView;

	/*
	 * 执行顺序先后 onAttach onCreate :保存恢复数据 onCreateView onActivityCreated 具体操作
	 */
	public static QuantianFragment getInstance(Bundle args) {
		springHotFragment = new QuantianFragment();
		if (args != null) {
