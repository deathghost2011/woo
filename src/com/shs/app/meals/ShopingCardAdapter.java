...
//		// .enableLogging();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			viewHolder.button=(CheckBox) convertView.findViewById(R.id.shopingcard_readiobutton1);
			...
			viewHolder.jia=(Button) convertView.findViewById(R.id.shopingcard_add);
			viewHolder.jian=(Button) convertView.findViewById(R.id.shopingcard_desc);
		...
		viewHolder.jia.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
					list.get(position).setShuliang(Integer.parseInt(list.get(position).getShuliang())+1+"");
					notifyDataSetChanged();
					ShopingCardActivity.handler.sendEmptyMessage(1);
			}
		});
		viewHolder.jian.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				if(Integer.parseInt(list.get(position).getShuliang())-1>0){
					list.get(position).setShuliang(Integer.parseInt(list.get(position).getShuliang())-1+"");
					notifyDataSetChanged();
					ShopingCardActivity.handler.sendEmptyMessage(1);
				}
