...
public class RegisterJson {
	...
	public  String ReturnJsonStr()
	{
       ...
       */  
       ...
       params.add(new BasicNameValuePair("realname", RegisterClass.getRealname()));  
       params.add(new BasicNameValuePair("uname", RegisterClass.getUname()));  
       params.add(new BasicNameValuePair("upwd", RegisterClass.getUpwd())); 
       params.add(new BasicNameValuePair("email", RegisterClass.getEmail()));  
       params.add(new BasicNameValuePair("mobile", RegisterClass.getMobile()));  
         /*发送请求并等待响应*/  
